...
console.log(`daysInMonth(2, 2022) === 28: ${daysInMonth(2, 2022) === 28}`);
console.log(`daysInMonth(2, 2024) === 29: ${daysInMonth(2, 2024) === 29}`);
console.log(`daysInMonth(22) === 'Not valid month.': ${daysInMonth(22) === 'Not valid month.'}`);
